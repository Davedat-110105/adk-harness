"""Print a governed Google Workspace run and its cleanup instructions.
...
This example only prints cleanup instructions; it does not delete calendar
data. Review the event and remove it manually if you ran the live example.
"""
...
from adk_harness import Applicability, build_workspace_app
...
async def main() -> int:
    ...
    print("\nThis script does not delete data. Check your calendar for 2026-09-11")
    print("and remove the event manually if this live example created one.")
    return 0
