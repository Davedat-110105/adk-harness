...
three without knowing the difference.
    ...
    GOOGLE_CLOUD_PROJECT=... python examples/scripts/multi_adapter_fleet.py "your task"
...
from adk_harness.coding.adapters import AntigravityHarness, CodexHarness, OpenCodeHarness
