...
Three shapes, one protocol: Codex is a CLI subprocess, Claude Code is a Python
SDK, opencode is an HTTP server with an SSE event stream. Two adapters can
accidentally agree with each other; three that disagree structurally and still
